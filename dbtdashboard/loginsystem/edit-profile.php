...
$userid=$_SESSION['id'];
    $msg=mysqli_query($con,"update users set fname='$fname',lname='$lname', cname='$cname', contactno='$contact' where id='$userid'");
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       ...
                                       <td><input class="form-control" id="cname" name="cname" type="text" value="<?php echo $result['cname'];?>"  required /></td>
                                   </tr>
                                         <tr>
                                       <th>Contact No.</th>

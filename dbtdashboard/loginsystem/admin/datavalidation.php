...
$sqli = "INSERT INTO `tblfiles` (`StateName`,`FileName`, `Location`) VALUES ('{$statename}','{$filename}','{$location}')";
...
?>
<center>
<h1>CENTER WISE DATA UPLOADED </h1>
<!-- <form class="form" method="post" action="" enctype="multipart/form-data">
  <label>Enter State Name: </label>  &nbsp; <input type="text" name="statename"> <br> 
<label>Select Disease Name:</label>
 <input type="text" name="filename" > <br/> 
  <option value="Brucellosis">Brucellosis</option> 
  <option value="Tuberculosis">Tuberculosis</option>
  <option value="Q Fever">Q Fever</option>
  <option value=" Scrub Typhusi"> Scrub Typhus</option>
  <option value="Japanese Encephalitis"> Japanese Encephalitis</option>
  <option value="Brucellosis"> CCHF</option>
  <option value="Cryptosporidiosis"> Cryptosporidiosis</option>
  <option value="Cysticercosis">Cysticercosisr</option>
  ...
  <option value=" Swine influenza"> Swine influenza</option>
...
/*echo '<td><a class="btn" href=" delete.php?file_id=<?php'.$row['ID'].'">Delete</a></td>';*/
...
<td><a class="btn" href="http://localhost/wordpressnk/dbtdashboard/loginsystem/admin/dashboard.php">Home Page</a></td>
</div>

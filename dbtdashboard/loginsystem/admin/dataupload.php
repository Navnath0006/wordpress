...
if (isset($_POST['save'])) {
$target_dir = "file/Uploaded_Files/";
...
$location = "file/Uploaded_Files/" . $files;
...
echo '<td><a class="btn" href="#">Home Page</a></td>';
echo '</tr>';
}
mysqli_close($con);
?>

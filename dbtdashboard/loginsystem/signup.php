...
if($row>0)
{
    ...
    $msg=mysqli_query($con,"insert into users(fname,lname,cname,email,password,contactno) values('$fname','$lname','$cename','$email','$password','$contact')");
...
<input class="form-control" id="cname" name="cname" type="text" placeholder="Enter Institue Name" required />
<label for="inputEmail">Institute Name</label>
</div>
